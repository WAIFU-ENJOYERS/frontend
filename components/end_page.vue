        ...
        <div class="game-end">
            <div class="game-end__wrapper">
                <div class="game-end-score-wrapper">
                    <p class="game-end-score">You scored:
                        <span class="game-end-score__score"><Score></Score></span></p>
                </div>
                <v-btn @click="$emit('homepage')" class="game-end-button" rounded="pill" variant="flat" color="orange"
                       size="x-large">
                    <p class="text-button font-weight-bold text-white">Back to menu</p>
                </v-btn>
                <v-btn @click="$emit('play')" class="mx-5 my-5 game-end-button" rounded="pill" variant="flat"
                       color="success" size="x-large">
