import { version as version$1, toRefs, createVNode, Transition, mergeProps, ref, computed, watch, nextTick, toRef, Text, watchEffect, provide, onScopeDispose, withDirectives, resolveDirective, vShow, Fragment as Fragment$1, reactive, inject as inject$1, capitalize, h, getCurrentInstance as getCurrentInstance$1, readonly, unref, shallowRef, defineComponent as defineComponent$1, camelize, toRaw, TransitionGroup, isRef, resolveDynamicComponent, cloneVNode, effectScope, warn, toHandlers, Teleport, createTextVNode, vModelText, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, isReadonly, defineAsyncComponent, withCtx, Suspense } from 'vue';
...
import { u as useRuntimeConfig$1 } from '../nitro/firebase.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-219491c8.mjs').then((m) => m.default || m)
  }
];
...
const vuetify_7h9QAQEssH = /* @__PURE__ */ defineNuxtPlugin((nuxt) => {
...
const layouts = {
  default: () => import('./_nuxt/default-9c6a5195.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-229b954d.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-361b9a66.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useHead as a, createError as c, entry$1 as default, navigateTo as n, useRouter$1 as u };
